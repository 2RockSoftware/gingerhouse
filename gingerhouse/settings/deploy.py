...
if 'DATABASE_URL' in os.environ:
    ...
    WEBSERVER_ROOT = '/var/www/gingerhouse/'
...
EMAIL_SUBJECT_PREFIX = '[Gingerhouse %s] ' % ENVIRONMENT.title()
...
# BROKER_URL = 'amqp://gingerhouse_%(ENVIRONMENT)s:%(BROKER_PASSWORD)s@%(BROKER_HOST)s/gingerhouse_%(ENVIRONMENT)s' % os.environ  # noqa
